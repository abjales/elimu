        ...
        <CardContent>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-[#7a7468]">Or</span>
            </div>
          </div>

          <Button variant="outline" className="w-full border-border text-stone-700 hover:bg-stone-50 rounded-full" onClick={handleGoogleSignup}>
